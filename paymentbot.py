...
def start_with_shipping_callback(update, context):
    ...
    provider_token = "401643678:TEST:05f468cb-0b46-414b-b94b-9d5bb21a6fd9"
...
def main():
    ...
    print(1)
    updater = Updater("820019940:AAGY7FtvDoE8rqM4LitbK4_TJyLcWTzhZjg", use_context=True)
    # updater.bot.set_webhook(url='https://0320f82f.ngrok.io')
